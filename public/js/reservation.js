...
function LangChange() {
  LangInit()
  // 重新渲染網頁文字
  $('#title1').html(`${i18n.t('Vender Book & Visit Statistics')}`) // 個人廠商出入廠資訊明細
  $('#title2').html(`${i18n.t('Factory')}`) // 廠區
  $('#title3').html(`${i18n.t('Department ID')}`) // 部門代號
  $('#title4').html(`${i18n.t('Query Data')}`) // 查詢資訊
  $('#title5').html(`${i18n.t('Date')}`) // 查詢日期
  ...
  $(document).attr('title', i18n.t('Vender Book & Visit Statistics')) // 修改網頁標題
